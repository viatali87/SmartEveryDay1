...
namespace Remoni.API.DataAccess.Client.Models
{
    ...
    public partial class AccountNoRefsDto
    {
        /// <summary>
        /// Initializes a new instance of the AccountNoRefsDto class.
        /// </summary>
        public AccountNoRefsDto() { }

        /// <summary>
        /// Initializes a new instance of the AccountNoRefsDto class.
        /// </summary>
        public AccountNoRefsDto(int accountId, string name, string address, string billingAddress = default(string))
        {
            AccountId = accountId;
            Name = name;
            Address = address;
