...
namespace Remoni.API.DataAccess.Client.Models
{
    ...
    public partial class PropertyValueError
    {
        /// <summary>
        /// Initializes a new instance of the PropertyValueError class.
        /// </summary>
        public PropertyValueError() { }

        /// <summary>
        /// Initializes a new instance of the PropertyValueError class.
        /// </summary>
        public PropertyValueError(string property, string code, string message)
        {
            Property = property;
            Code = code;
            Message = message;
