...
namespace Remoni.API.DataAccess.Client
{
    ...
    /// </summary>
    public partial class DataTypes : Microsoft.Rest.IServiceOperations<RemoniAPIClient>, IDataTypes
    {
        /// <summary>
        /// Initializes a new instance of the DataTypes class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        public DataTypes(RemoniAPIClient client)
        {
            if (client == null) 
            {
        ...
        public async System.Threading.Tasks.Task<Microsoft.Rest.HttpOperationResponse<object>> GetCollectionWithHttpMessagesAsync(System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                Microsoft.Rest.ServiceClientTracing.Enter(_invocationId, this, "GetCollection", tracingParameters);
            }
            // Construct URL
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<System.Collections.Generic.IList<ReadDataTypeDto>>(_responseContent, this.Client.DeserializationSettings);
                }
